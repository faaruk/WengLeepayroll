...
{
    public partial class ExecuteReportDateRange : Form
    {
        DataTable dtGlobal = new DataTable();
        public ExecuteReportDateRange()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = objRD.GetAttendanceResultArchiveDateDuration(strEmpID, cmbSortBy.SelectedValue.ToString(), cmbSortOption.SelectedValue.ToString(), strFromDate, strToDate);
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                ReadData objRD = new ReadData();
                DataSet ds = objRD.GetCoverPageArchiveDateDuration(strEmpID, cmbSortBy.SelectedValue.ToString(), cmbSortOption.SelectedValue.ToString(), strFromDate, strToDate,30,10);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = objRD.GetLeaveDataDateDuration(strEmpID, cmbSortBy.SelectedValue.ToString(), cmbSortOption.SelectedValue.ToString(), strFromDate, strToDate);
                this.reportViewer1.Reset();
        ...
        private void dteFromDate_MouseDown(object sender, MouseEventArgs e)
        {
            panel1.Visible = false;
        }
        ...
        private void dteToDate_MouseDown(object sender, MouseEventArgs e)
        {
            panel1.Visible = false;
        }
        ...
        private void ExecuteReportDateRange_Click(object sender, EventArgs e)
        {
            panel1.Visible = false;
        }
